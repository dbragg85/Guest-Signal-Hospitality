...
## Opening Signal
This week's operator focus is **Restaurant value menus**. Guest behavior this week points to tighter expectations around response quality and accountability.
Also monitor **Restaurant delivery wait times** as an operator watchlist topic—not a verified search spike.
